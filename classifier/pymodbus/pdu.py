...
from pymodbus.utilities import rtuFrameSize,rtuFrameDoubleBcSize
...
class ModbusPDU(object):
    ...
    def calculateRtuFrameSize(cls, buffer):
        ...
        elif hasattr(cls, '_rtu_double_byte_count_pos'):
            return rtuFrameDoubleBcSize(buffer, cls._rtu_double_byte_count_pos)     
